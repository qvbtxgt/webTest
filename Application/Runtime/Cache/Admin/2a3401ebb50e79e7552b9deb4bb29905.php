...
<div class="top">
	<div class="top-box">
		...
		<div class="top-box-nav">
			欢迎您！<a href="#">我的信息</a> <a href="#">密码修改</a> <a href="/test/index.php/Admin/Index/logout">安全退出</a>
		</div>
	</div>
</div>
<div class="main">
	<div class="main-left">
		<div class="main-left-nav">
			...
			<a href="/test/index.php/Admin/Student/show">专业列表</a>
			<a href="#">添加专业</a>
			...
			<div class="main-left-nav-list">
				<div><a href="/test/index.php/Admin/Student/showList">学生列表</a></div>
