    ...
    <div id="base" class="">
      ...
      <div id="u6" class="ax_文本">
        ...
        <div id="u7" class="text">
          <p><span>密&nbsp;&nbsp; 码</span><span>：</span></p>
        </div>
      </div>

      <!-- Unnamed (形状) -->
      <div id="u8" class="ax_形状">
        <img id="u8_img" class="img " src="images/login/u8.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (形状) -->
      <div id="u12" class="ax_文本" title="暂无此功能">
      ...
      <!-- username (文本框(单行)) -->
      <div id="u14" class="ax_文本框_单行_" data-label="username">
        <input id="u14_input" type="text" value=""/>
      </div>

      <!-- userpassword (文本框(单行)) -->
      <div id="u15" class="ax_文本框_单行_" data-label="userpassword">
