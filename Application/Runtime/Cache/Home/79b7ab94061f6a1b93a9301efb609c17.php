  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u0" class="ax_动态面板">
        <div id="u0_state0" class="panel_state" data-label="organization">
          <div id="u0_state0_content" class="panel_state_content">
            ...
            <div id="u13" class="ax_文本">
              ...
              <div id="u14" class="text">
                <p><span>代表</span><span>组织</span><span></span><span>：</span></p>
              </div>
            </div>
            ...
            <div id="u15" class="ax_文本">
              ...
              <div id="u16" class="text">
                <p><span>确</span><span>认</span><span>密码</span><span></span><span>：</span></p>
              </div>
            </div>
            ...
            <!-- Unnamed (文本框(单行)) -->
            <div id="u21" class="ax_文本框_单行_">
              <input id="u21_input" type="password" value=""/>
            </div>

            <!-- Unnamed (文本框(单行)) -->
            <div id="u22" class="ax_文本框_单行_">
              <input id="u22_input" type="email" value=""/>
            </div>

            <!-- Unnamed (文本框(单行)) -->
            <div id="u23" class="ax_文本框_单行_">
              <input id="u23_input" type="number" value=""/>
            </div>

            <!-- Unnamed (文本框(单行)) -->
            <div id="u24" class="ax_文本框_单行_">
        ...
        <div id="u0_state1" class="panel_state" data-label="personal">
          <div id="u0_state1_content" class="panel_state_content">
            ...
            <div id="u38" class="ax_文本">
              ...
              <div id="u39" class="text">
                <p><span>所属</span><span>组织</span><span></span><span>：</span></p>
              </div>
            </div>
            ...
            <div id="u43" class="ax_文本框_单行_">
              <input id="u43_input" type="password" value=""/>
            </div>
            ...
            <div id="u45" class="ax_文本框_单行_">
              <input id="u45_input" type="password" value=""/>
            </div>

            <!-- Unnamed (文本框(单行)) -->
            <div id="u46" class="ax_文本框_单行_">
              <input id="u46_input" type="email" value=""/>
            </div>

            <!-- Unnamed (文本框(单行)) -->
            <div id="u47" class="ax_文本框_单行_">
              <input id="u47_input" type="number" value=""/>
            </div>
            ...
            <!-- Unnamed (文本框(单行)) -->
            <div id="u49" class="ax_文本框_单行_">
              <input id="u49_input" type="text" value=""/>
            </div>

            <!-- Unnamed (下拉列表框) -->
            <div id="u50" class="ax_下拉列表框">
              <select id="u50_input">
                <option value="西电青年志愿者总队">西电青年志愿者总队</option>
                <option value="西电彩云协会">西电彩云协会</option>
                <option value="西电通院地平线">西电通院地平线</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div id="u51" class="ax_单选框">
        ...
        <input id="u51_input" type="radio" value="radio" name="select" checked/>
      </div>

      <!-- Unnamed (单选框) -->
      <div id="u53" class="ax_单选框">
        <label for="u53_input">
          <!-- Unnamed () -->
        ...
        <input id="u53_input" type="radio" value="radio" name="select"/>
      </div>

      <!-- Unnamed (形状) -->
      <div id="u55" class="ax_形状">
        <img id="u55_img" class="img " src="images/项目管理/u84.png"/>
        <!-- Unnamed () -->
